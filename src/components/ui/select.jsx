    ...
    return (
      <SelectPrimitive.Portal>
        <div className="fixed inset-x-0 bottom-0 z-50 pb-safe">
          <div className="bg-[#0d1a2d]/95 backdrop-blur-xl border-t border-[#1a2d4a] rounded-t-3xl shadow-xl">
            <div className="w-12 h-1 bg-[#2a4a6a] rounded-full mx-auto mt-3 mb-2" />
